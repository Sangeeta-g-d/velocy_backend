...
class SupportChatConsumer(AsyncJsonWebsocketConsumer):
    async def connect(self):
        ...
        # Check if the user is a staff member for the admin panel (chat_id=0)
        # or if they are the correct user for a specific chat.
        if self.chat_id == "0":
        ...
        # Admins join a separate group to receive all messages
        if self.chat_id == "0":
